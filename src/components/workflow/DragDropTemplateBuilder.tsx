...
import { Plus, Trash2, GripVertical, Save, X, Clock, User } from "lucide-react";
...
const DragDropTemplateBuilder: React.FC<DragDropTemplateBuilderProps> = ({
  template,
  onSave,
  onCancel
}) => {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Design reusable workflow templates with drag & drop steps
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Drag and drop to reorder steps. Configure SLAs and approvers for each step.
              </CardDescription>
            </div>
                      ...
                      <Draggable key={step.id} draggableId={step.id} index={index}>
                        {(provided, snapshot) => (
                          <Card 
                            ...
                            className={`border transition-shadow ${snapshot.isDragging ? 'shadow-lg' : ''}`}
                          >
