  ...
  public: {
    Tables: {
      ...
      notification_delivery_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "notification_delivery_logs_alert_id_fkey"
            columns: ["alert_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "notification_delivery_logs_channel_id_fkey"
            columns: ["channel_id"]
            isOneToOne: false
