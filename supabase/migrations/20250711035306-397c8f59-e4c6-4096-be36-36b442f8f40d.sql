-- Continue Phase 1: Update existing policies instead of creating new ones

-- Update existing user_roles policies
DROP POLICY IF EXISTS "Users can view roles in their organization" ON public.user_roles;
DROP POLICY IF EXISTS "Users can view their org user roles" ON public.user_roles;
DROP POLICY IF EXISTS "Admins can manage user roles in their org" ON public.user_roles;
