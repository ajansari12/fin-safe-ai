-- Add some sample operational data with correct column names
...
('ce1b0f79-5c5a-4e2d-8d15-18dbbb61d845', 'Data Synchronization Failure', 'Third-party vendor data sync failed', 'high', 'data', 'in_progress', NOW() - INTERVAL '2 days', 2, 8),
